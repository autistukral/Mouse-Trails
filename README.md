Simple app that let's you change the mouse trail count (up to a value of 100) so that when using apps such as Parsec other people connected to you via Parsec can see your cursor.
